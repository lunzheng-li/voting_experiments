...
class Constants(BaseConstants):
    ...
    instructions_template = 'Agranov_etal_2018/Instructions_temp.html'
...
class Group(BaseGroup):
    ...
    poll_red = models.IntegerField()
    poll_blue = models.IntegerField()
    poll_abstain = models.IntegerField()
    ...
    def poll_results(self):
        polls = [p.poll for p in self.get_players()]
        self.poll_red = polls.count('Vote Red')
        self.poll_blue = polls.count('Vote Blue')
        self.poll_abstain = polls.count('Abstain')
...
class Player(BasePlayer):
    ...
    poll = models.StringField(
        ...
        label='''Please indicate what you plan to do
        (this will not restrict your ultimate choice)'''
    )
    # guesses
    # guess on real types
